...
def add_sample_data():
    ...
    for employee_data in employees_data:
        ...
        employee_data["name"] = aes_string.aes_encrypt_string(employee_data["name"],key, 16).hex()
        employee_data["email"] = aes_string.aes_encrypt_string(employee_data["email"],key, 16).hex()
        employee_data["gender"] = aes_string.aes_encrypt_string(employee_data["gender"],key, 16).hex()
        employee_data["date_of_birth"] = aes_string.aes_encrypt_string(employee_data["date_of_birth"],key, 16).hex()
        employee_data["probationary_end_date"] = aes_string.aes_encrypt_string(employee_data["probationary_end_date"],key, 16).hex()
        employee_data["probationary_start_date"] = aes_string.aes_encrypt_string(employee_data["probationary_start_date"],key, 16).hex()
        employee_data["official_start_date"] = aes_string.aes_encrypt_string(employee_data["official_start_date"],key, 16).hex()
        employee_data["tax_code"] = aes_string.aes_encrypt_string(employee_data["tax_code"],key, 16).hex()
        employee_data["social_insurance_code"] = aes_string.aes_encrypt_string(employee_data["social_insurance_code"],key, 16).hex()
        employee_data["type"] = aes_string.aes_encrypt_string(employee_data["type"],key, 16).hex()
        employee_data["level"] = aes_string.aes_encrypt_string(employee_data["level"],key, 16).hex()
        employee_data["phone_number"] = aes_string.aes_encrypt_string(employee_data["phone_number"],key, 16).hex()
        employee_data["citizen_identification_code"] = aes_string.aes_encrypt_string(employee_data["citizen_identification_code"],key, 16).hex()
        employee_data["personal_email"] = aes_string.aes_encrypt_string(employee_data["personal_email"],key, 16).hex()
        employee_data["birthplace"] = aes_string.aes_encrypt_string(employee_data["birthplace"],key, 16).hex()
        employee_data["current_address"] = aes_string.aes_encrypt_string(employee_data["current_address"],key, 16).hex()
        employee_data["permanent_address"] = aes_string.aes_encrypt_string(employee_data["permanent_address"],key, 16).hex()
        employee_data["bank_name"] = aes_string.aes_encrypt_string(employee_data["bank_name"],key, 16).hex()
        employee_data["bank_account_number"] = aes_string.aes_encrypt_string(employee_data["bank_account_number"],key, 16).hex()
        employee_data["education"] = aes_string.aes_encrypt_string(employee_data["education"],key, 16).hex()
        employee_data["graduation_year"] = aes_string.aes_encrypt_string(employee_data["graduation_year"],key, 16).hex()
